          ...
          Padding(
            ...
            child: Text(
              context.watch<SearchBloc>().searchStarted == false
                  ? easy.tr('recent searchs')
                  : easy.tr('we have found'),
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          hintText: easy.tr("search & explore"),
          hintStyle: TextStyle(
              fontSize: 16,
  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(
      child: sb.recentSearchData.isEmpty
          ? EmptyPage(
              icon: Feather.search,
              message: easy.tr('search for places'),
              message1: easy.tr("search-description"),
            )
          : ListView.builder(
